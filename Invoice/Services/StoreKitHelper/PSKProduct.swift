...
class PSKProduct: SKProduct {
    ...
    class func getDemoProducts() -> [SKProduct] {
        ...
        let paymentMode4 = SKProductDiscount.PaymentMode.freeTrial
        let subscriptionPeriod4 = PSKProductSubscriptionPeriod(numberOfUnits: 3, unit: .day)
        let introductoryPrice4 = PSKProductDiscount(price: 29.49,
                                                    priceLocale: Locale(identifier: "en-US"),
                                                    paymentMode: paymentMode4,
                                                    subscriptionPeriod: subscriptionPeriod4)
        
        let product4 = PSKProduct(localizesTitle: "Name 4",
                                  price: NSDecimalNumber(value: 29.49),
                                  priceLocale: Locale(identifier: "en-US"),
                                  introductoryPrice: introductoryPrice4,
                                  subscriptionPeriod: PSKProductSubscriptionPeriod(numberOfUnits: 3, unit: .month))
        
        //array.append(product4)
        
        
        let paymentMode2 = SKProductDiscount.PaymentMode.freeTrial
        let subscriptionPeriod2 = PSKProductSubscriptionPeriod(numberOfUnits: 5, unit: .day)
        let introductoryPrice2 = PSKProductDiscount(price: 49.49,
                                                    priceLocale: Locale(identifier: "en-US"),
                                                    paymentMode: paymentMode2,
                                                    subscriptionPeriod: subscriptionPeriod2)
        
        let product2 = PSKProduct(localizesTitle: "Name 2",
                                  price: NSDecimalNumber(value: 49.49),
                                  priceLocale: Locale(identifier: "en-US"),
                                  introductoryPrice: introductoryPrice2,
                                  subscriptionPeriod: PSKProductSubscriptionPeriod(numberOfUnits: 1, unit: .year))
        
        array.append(product2)
        
        
        let paymentMode3 = SKProductDiscount.PaymentMode.payAsYouGo
        let subscriptionPeriod3 = PSKProductSubscriptionPeriod(numberOfUnits: 0, unit: .day)
        let introductoryPrice3 = PSKProductDiscount(price: 99.99,
                                                   priceLocale: Locale(identifier: "en-US"),
                                                   paymentMode: paymentMode3,
                                                   subscriptionPeriod: subscriptionPeriod3)
        
        let product3 = PSKProduct(localizesTitle: "Name 3",
                                  price: NSDecimalNumber(value: 99.99),
                                  priceLocale: Locale(identifier: "en-US"),
